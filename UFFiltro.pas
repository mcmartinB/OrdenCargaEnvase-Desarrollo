...
type
  TFFiltro = class(TForm)
    ...
    lbl_planta_destino_occ: TLabel;
    edt_planta_destino_occ: TBEdit;
...
begin
  ...
  begin
    ...
    if Trim( edt_planta_destino_occ.Text ) <> '' then
    begin
       if bFlag then
         result:= result + ' and ';
       result:= result + ' planta_destino_occ = ' + QuotedStr( edt_planta_destino_occ.Text );
       bFlag:= True;
    end;
...
procedure TFFiltro.edt_planta_destino_occChange(Sender: TObject);
begin
  st_planta_destino_occ.Caption:= DDescripciones.desEmpresa( edt_planta_destino_occ.Text );
  STcentro_destino_occ.Caption:= DDescripciones.desCentro( edt_planta_destino_occ.Text, centro_destino_occ.Text );
end;
...
procedure TFFiltro.btn_planta_destino_occClick(Sender: TObject);
begin
