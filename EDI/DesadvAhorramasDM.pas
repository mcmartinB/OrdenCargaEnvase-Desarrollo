...
begin
  ...
  begin
    ...
    sql.Add('                         left join frf_envases on empresa_e = empresa_pl ');
    sql.Add('                                             and envase_e = envase_pl ');
    sql.Add('                                             and producto_base_e = producto_base_pl ');
  ...
  begin
    ...
    sql.Add(' from frf_orden_carga_l  left join frf_envases on empresa_e = empresa_ocl  ');
    sql.Add('                                           and envase_e = envase_ocl ');
    sql.Add('                                             and producto_base_e = (select producto_base_p from frf_productos   ');
    sql.Add('                                                                    where empresa_p = empresa_ocl  ');
    sql.Add('                                                                    and producto_p = producto_ocl )  ');
  ...
  begin
    ...
    sql.Add(' from frf_packing_list left join frf_envases on empresa_e = empresa_pl  ');
    sql.Add('                                              and envase_e = envase_pl  ');
    sql.Add('                                              and producto_base_e = producto_base_pl  ');
    sql.Add(' where orden_pl = :orden  ');
  ...
  kmtVerificar.FieldDefs.Add('codigo', ftString, 3, False);
...
begin
  ...
  sAux:= sAux + '#'; //#
  sAux:= sAux + '#'; //#
  sAux:= sAux + getPESON; //'#'; //# PESTOTLIN  --> getPESON;
  sAux:= sAux + '#'; //#
  sAux:= sAux + '#'; //#
  sAux:= sAux + '#'; //#
  sAux:= sAux + '#'; //#
  ...
  sAux:= sAux + '#'; //#
  sAux:= sAux + '#'; //#
  sAux:= sAux + '#'; //PESOBRUTO ->> qetPESTOTBRULIN
  sAux:= sAux + '#'; //getPESON; //'#'; PESONETO
  sAux:= sAux + '#'; //#
  sAux:= sAux + '#'; //#
  sAux:= sAux + '#'; //#
  sAux:= sAux + '#'; //#
